    ...
    class Program
    {
        static void Main(string[] args)
        {
           /* GreetUser();
            ...
            Myinvoice.DisplayInvoiceAmount(name);
            */

            // Accessing the array from Invoice class
            Invoice Myinvoice = new Invoice();
            int[] invoiceNumbers = Myinvoice.GetNumbers();
            DisplayInvoiceNumbers(invoiceNumbers);
        }
        ...
        static void DisplayInvoiceNumbers(int[] numbers)
        {
